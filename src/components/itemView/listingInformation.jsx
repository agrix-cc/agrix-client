    ...
    return (
        <div className="mt-6 mb-[120px] px-4">
            ...
            <div className="mb-2 flex justify-between items-center">
                <div>
                    <p className="text-2xl font-medium">Rs. {pricing.price}</p>
    ...
    return (
        <div>
            ...
            <ul className="list-disc mx-6">
                ...
                <li className="text-gray-500">Delivery: <span className="capitalize text-black">{delivery_options}</span></li>
                <li className="text-gray-500">Available Quantity: <span className="text-black">{available_quantity} Kg</span></li>
                <li className="text-gray-500">Price per Kg: <span className="text-black">Rs. {price_per_kg}</span></li>
    ...
    return (
        <div>
            ...
            <ul className="list-disc mx-6">
                ...
                <li className="text-gray-500">Price per Km: <span className="text-black">Rs. {price_per_km}</span></li>
    ...
    return (
        <div>
            ...
            <ul className="list-disc mx-6">
                ...
                <li className="text-gray-500">Price per Unit: <span className="text-black">Rs. {price_per_unit}</span></li>
